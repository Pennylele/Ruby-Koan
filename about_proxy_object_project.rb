...
class Proxy
	...
	def initialize(target_object) #initializing the proxy data structure
		@object = target_object
		@messages = []
	end
	
	def called?(msg)
		@messages.include?(msg) #Line 78: to check if the message is called or not.
	end
	
	def number_of_times_called(msg) #Line 95: check how many times the message is called.
		@messages.count(msg)
	end
