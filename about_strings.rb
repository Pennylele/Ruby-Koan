...
EOS
  ...
  def test_the_shovel_operator_modifies_the_original_string
    ...
    #I think because the (<<) can help build up the string to the variable that the inital variable it builds to equals to
  end
  ...
  in_ruby_version("1.8") do
    def test_in_older_ruby_single_characters_are_represented_by_integers
      assert_equal 97, ?a #need to type in ?.ord to see the integers. If use ruby 1.8.7, just type in ?a, the integer will show up.
