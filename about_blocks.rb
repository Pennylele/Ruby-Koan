...
class AboutBlocks < Neo::Koan
  def method_with_block
    result = yield #what does this do?
    result
  end
  ...
  def test_blocks_can_take_arguments
    method_with_block_arguments do |argument| #when you say yield("Jim") you are handing the String "Jim" back to whoever calls method_with_block_arguments.
  ...
  def test_stand_alone_blocks_can_be_passed_to_methods_expecting_blocks
    ...
    result = method_with_block_arguments(&make_upper) # $ shows that the variable is a global variable
