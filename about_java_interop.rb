...
class AboutJavaInterop < Neo::Koan
  ...
  def test_include_class_includes_class_in_module_scope
    ...
    assert_equal nil, defined?(TreeSet)
  end
  ...
  def test_java_string_are_not_ruby_strings
    ...
    assert_equal false, java_string.is_a?(java.lang.String)
    assert_equal true, java_string.is_a?(String)
  end
  ...
  def test_some_ruby_objects_can_be_coerced_to_java
    assert_equal String, "ruby string".to_java.class
    assert_equal Fixnum, 1.to_java.class
    assert_equal Fixnum, 9.32.to_java.class
    assert_equal FalseClass, false.to_java.class
  end
